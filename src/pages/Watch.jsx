...
const VideoPage = () => {
  ...
  const fetchVideoData = async () => {
    try {
      setLoading(true);
      const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/video/${videoId}`);
  ...
  const fetchSuggestedVideos = async () => {
    try {
      const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/videos`);
  ...
  const fetchChannelData = async () => {
    try {
      const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/channelbyid/${videoData.channel._id}`);
      if (response.data.success) {
  ...
  const handleSubscribeClick = async () => {
    try {
      ...
      let response;
      if (isSubscribed) {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/channel/unsubscribe/${channelData._id}`, {}, config);
      } else {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/channel/subscribe/${channelData._id}`, {}, config);
      }
  ...
  const handleLikeClick = async () => {
    try {
      ...
      let response;
      if (isLiked) {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/video/unlike/${videoData._id}`, {}, config);
        if(response.data.success){
          setLikes(likes-1)
        }
       
      } else {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/video/like/${videoData._id}`, {}, config);
        if(response.data.success){
          setLikes(likes+1)
        }
  ...
  const handleDislikeClick = async () => {
    try {
      ...
      let response;
      if (isDisliked) {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/video/undodislike/${videoData._id}`, {}, config);
      } else {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/video/dislike/${videoData._id}`, {}, config);
      }
      if (response.data.success) {
  ...
  const increamentViews = async () => {
    try {
      const res = axios.get(`https://youtube-backend-eo4h.onrender.com/api/video/view/${videoData._id}`);
      if (res.data.success) {
