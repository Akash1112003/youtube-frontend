...
const OwnChannelPage = () => {
  ...
  useEffect(() => {
    const fetchChannel = async () => {
      ...
      try {
        const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/channel`, { withCredentials: true });
  ...
  const fetchChannelVideos = async () => {
    try {
      ...
      const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/videos/channel/${channel._id}`, { withCredentials: true });
  ...
  const handleBannerChange = async(e) => {
    ...
    try {
      setLoading(true);
      const response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/upload/banner/${channel._id}`, formData, { withCredentials: true });
      if(response.data.success){
