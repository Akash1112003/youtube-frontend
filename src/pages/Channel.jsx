...
const ChannelPage = () => {
  ...
  const fetchChannelData = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/channel/${params.handle}`, { withCredentials: true });
  ...
  const fetchChannelVideos = async () => {
    try {
      ...
      const response = await axios.get(`https://youtube-backend-eo4h.onrender.com/api/videos/channel/${data._id}`, { withCredentials: true });
  ...
  const handleSubscribeClick = async () => {
    try {
      ...
      let response;
      if (isSubscribed) {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/channel/unsubscribe/${data._id}`, {}, config);
      } else {
        response = await axios.post(`https://youtube-backend-eo4h.onrender.com/api/channel/subscribe/${data._id}`, {}, config);
      }
