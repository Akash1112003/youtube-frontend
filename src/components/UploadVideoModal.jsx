    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (thumbnail) {
                ...
                const thumbnailresponse = await axios.post('https://youtube-backend-eo4h.onrender.com/api/upload/avatar', formData, {
            ...
            const response = await axios.post("https://youtube-backend-eo4h.onrender.com/api/video/upload", { title, description, thumbnailUrl: thumbnailUrl, category, assetUrl }, {
                withCredentials: true
            });
