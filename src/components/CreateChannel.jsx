  ...
  const handleCreate = async () => {
    try {
      ...
      if (avatar) {
        ...
        const avatarResponse = await axios.post('https://youtube-backend-eo4h.onrender.com/api/upload/avatar', formData, {
      ...
      const response = await axios.post('https://youtube-backend-eo4h.onrender.com/api/channel/create', 
        { 
